...
- 最新公开 Release：`v0.4.7`
- 扩展规范：Manifest V3
- 当前阶段：已发布首个 GitHub Release，支持开发者模式手动安装；浏览器商店版本暂不发布。
...
- Chrome Web Store：暂不发布；如未来决定上架，提交资料见 `CHROME_WEB_STORE_SUBMISSION.md`。
- Microsoft Edge Add-ons：暂不发布；如未来决定上架，提交资料见 `EDGE_STORE_LISTING.md`。
